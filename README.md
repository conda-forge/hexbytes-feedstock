...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hexbytes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10551&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hexbytes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hexbytes` can be installed with:

```
conda install hexbytes
```

It is possible to list all of the versions of `hexbytes` available on your platform with:
